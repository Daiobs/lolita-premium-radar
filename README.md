...
brand, with band counts, filters, and score breakdowns for scanning each action
tier.
...
from the web dashboard, review unsaved changes, reset drafts, and save them back
to the configured brand-weight file.
