...
""".strip(),
    ...
    def test_index_html_includes_language_switch(self) -> None:
        ...
        self.assertIn("styleCompass", INDEX_HTML)
        self.assertIn("style-compass-card", INDEX_HTML)
        self.assertIn("data-style-compass", INDEX_HTML)
        self.assertIn("renderStyleCompass", INDEX_HTML)
        self.assertIn("radar-nav", INDEX_HTML)
        self.assertIn("data-radar-jump", INDEX_HTML)
        self.assertIn("jumpToRadarSection", INDEX_HTML)
        self.assertIn("navNorthStar", INDEX_HTML)
        self.assertIn("northStarRadar", INDEX_HTML)
        self.assertIn("north-star-grid", INDEX_HTML)
        self.assertIn("renderNorthStarRadar", INDEX_HTML)
        self.assertIn("northStarStats", INDEX_HTML)
        self.assertIn("northStarLanes", INDEX_HTML)
        self.assertIn("northStarWeightedCoverage", INDEX_HTML)
        self.assertIn("northStarRunSheetHeat", INDEX_HTML)
        self.assertIn("navCrown", INDEX_HTML)
        self.assertIn("brandCrownQueue", INDEX_HTML)
        self.assertIn("crown-grid", INDEX_HTML)
        self.assertIn("renderBrandCrownQueue", INDEX_HTML)
        self.assertIn("brandCrownRows", INDEX_HTML)
        self.assertIn("brandCrownStats", INDEX_HTML)
        self.assertIn("crownActionLabel", INDEX_HTML)
        self.assertIn("crownConfidenceScore", INDEX_HTML)
        self.assertIn("crownConfidenceLabel", INDEX_HTML)
        self.assertIn("exportCrownCsvBtn", INDEX_HTML)
        self.assertIn("exportCrownCsv", INDEX_HTML)
        self.assertIn("csvFromCrownRows", INDEX_HTML)
        self.assertIn("lolita-brand-crown.csv", INDEX_HTML)
        self.assertIn("data-crown-keyword-sample", INDEX_HTML)
        self.assertIn("data-crown-apply", INDEX_HTML)
        self.assertIn("data-crown-target", INDEX_HTML)
        self.assertIn("weight_delta", INDEX_HTML)
        self.assertIn("formula_confidence", INDEX_HTML)
        self.assertIn("draftRiskRadar", INDEX_HTML)
        self.assertIn("draft-risk-grid", INDEX_HTML)
        self.assertIn("renderDraftRiskRadar", INDEX_HTML)
        self.assertIn("draftRiskScore", INDEX_HTML)
        self.assertIn("draftRiskNoOpen", INDEX_HTML)
        self.assertIn("data-draft-risk-review", INDEX_HTML)
        self.assertIn("brandWeightsPanel", INDEX_HTML)
        self.assertIn("navDaily", INDEX_HTML)
        self.assertIn("navReleaseWatch", INDEX_HTML)
        self.assertIn("navScenarios", INDEX_HTML)
        self.assertIn("weightScenarioCompare", INDEX_HTML)
        self.assertIn("scenario-grid", INDEX_HTML)
        self.assertIn("renderWeightScenarioCompare", INDEX_HTML)
        self.assertIn("weightScenarioSummary", INDEX_HTML)
        self.assertIn("scenarioPill", INDEX_HTML)
        self.assertIn("data-scenario-preview-apply", INDEX_HTML)
        self.assertIn("scenarioAvgTarget", INDEX_HTML)
        self.assertIn("scenarioApplyDraft", INDEX_HTML)
        self.assertIn("exportScenariosCsvBtn", INDEX_HTML)
        self.assertIn("exportWeightScenariosCsv", INDEX_HTML)
        self.assertIn("weightScenarioCsvRows", INDEX_HTML)
        self.assertIn("csvFromWeightScenarios", INDEX_HTML)
        self.assertIn("lolita-weight-scenarios.csv", INDEX_HTML)
        self.assertIn("noScenariosCsv", INDEX_HTML)
        self.assertIn("dailyRadarBrief", INDEX_HTML)
        self.assertIn("renderDailyRadarBrief", INDEX_HTML)
        self.assertIn("dailyRadarActions", INDEX_HTML)
        self.assertIn("dailyRadarLanes", INDEX_HTML)
        self.assertIn("dailyAverageScore", INDEX_HTML)
        self.assertIn("activeDailyLane", INDEX_HTML)
        self.assertIn("daily-lanes", INDEX_HTML)
        self.assertIn("dailyActionLanes", INDEX_HTML)
        self.assertIn("dailyLaneAll", INDEX_HTML)
        self.assertIn("dailyNoFilteredActions", INDEX_HTML)
        self.assertIn("data-daily-lane", INDEX_HTML)
        self.assertIn("data-daily-jump", INDEX_HTML)
        self.assertIn("data-daily-sample", INDEX_HTML)
        self.assertIn("data-daily-keyword-brand", INDEX_HTML)
        self.assertIn("exportDailyCsvBtn", INDEX_HTML)
        self.assertIn("exportDailyRadarCsv", INDEX_HTML)
        self.assertIn("csvFromDailyRadarActions", INDEX_HTML)
        self.assertIn("lolita-daily-radar.csv", INDEX_HTML)
        self.assertIn("releaseWatchQueue", INDEX_HTML)
        self.assertIn("release-grid", INDEX_HTML)
        self.assertIn("renderReleaseWatchQueue", INDEX_HTML)
        self.assertIn("releaseWatchRows", INDEX_HTML)
        self.assertIn("releaseBrandMatches", INDEX_HTML)
        self.assertIn("releaseKeywordMatches", INDEX_HTML)
        self.assertIn("data-release-sample", INDEX_HTML)
        self.assertIn("releaseActionSample", INDEX_HTML)
        self.assertIn("exportReleaseWatchCsvBtn", INDEX_HTML)
        self.assertIn("exportReleaseWatchCsv", INDEX_HTML)
        self.assertIn("csvFromReleaseWatchRows", INDEX_HTML)
        self.assertIn("lolita-release-watch.csv", INDEX_HTML)
        self.assertIn("noReleaseWatchCsv", INDEX_HTML)
        self.assertIn("navLookbook", INDEX_HTML)
        self.assertIn("brandLookbook", INDEX_HTML)
        self.assertIn("lookbook-grid", INDEX_HTML)
        self.assertIn("renderBrandLookbook", INDEX_HTML)
        self.assertIn("brandLookbookRows", INDEX_HTML)
        self.assertIn("lookbookFitScore", INDEX_HTML)
        self.assertIn("data-lookbook-sample", INDEX_HTML)
        self.assertIn("data-lookbook-keyword-brand", INDEX_HTML)
        self.assertIn("navScorecard", INDEX_HTML)
        self.assertIn("brandWeightScorecard", INDEX_HTML)
        self.assertIn("scorecard-grid", INDEX_HTML)
        self.assertIn("renderBrandWeightScorecard", INDEX_HTML)
        self.assertIn("brandWeightScorecardRows", INDEX_HTML)
        self.assertIn("scorecardVerdict", INDEX_HTML)
        self.assertIn("data-scorecard-apply", INDEX_HTML)
        self.assertIn("data-scorecard-sample", INDEX_HTML)
        self.assertIn("exportScorecardsCsvBtn", INDEX_HTML)
        self.assertIn("exportBrandWeightScorecardsCsv", INDEX_HTML)
        self.assertIn("csvFromBrandWeightScorecards", INDEX_HTML)
        self.assertIn("lolita-weight-scorecards.csv", INDEX_HTML)
        self.assertIn("navCoreWatch", INDEX_HTML)
        self.assertIn("navIdentity", INDEX_HTML)
        self.assertIn("navFormula", INDEX_HTML)
        self.assertIn("navGuardrails", INDEX_HTML)
        self.assertIn("brandWeightGuardrails", INDEX_HTML)
        self.assertIn("guardrail-grid", INDEX_HTML)
        self.assertIn("renderBrandWeightGuardrails", INDEX_HTML)
        self.assertIn("brandWeightGuardrailRows", INDEX_HTML)
        self.assertIn("brandWeightGuardrailStats", INDEX_HTML)
        self.assertIn("guardrailLaneRows", INDEX_HTML)
        self.assertIn("brandWeightGuardrailHtml", INDEX_HTML)
        self.assertIn("guardrailCoreGap", INDEX_HTML)
        self.assertIn("guardrailUnderweighted", INDEX_HTML)
        self.assertIn("data-guardrail-apply", INDEX_HTML)
        self.assertIn("data-guardrail-sample", INDEX_HTML)
        self.assertIn("exportGuardrailsCsvBtn", INDEX_HTML)
        self.assertIn("exportBrandWeightGuardrailsCsv", INDEX_HTML)
        self.assertIn("csvFromBrandWeightGuardrails", INDEX_HTML)
        self.assertIn("lolita-weight-guardrails.csv", INDEX_HTML)
        self.assertIn("noGuardrailsCsv", INDEX_HTML)
        ...
        self.assertIn("sampleTaskHint", INDEX_HTML)
        self.assertIn("sampleTaskAnchorHint", INDEX_HTML)
        self.assertIn("coreWatchTaskSource", INDEX_HTML)
        ...
        self.assertIn("brandWeightSalon", INDEX_HTML)
        self.assertIn("weight-salon", INDEX_HTML)
        self.assertIn("renderBrandWeightSalon", INDEX_HTML)
        self.assertIn("brandWeightSalonRows", INDEX_HTML)
        self.assertIn("salonAction", INDEX_HTML)
        self.assertIn("salonActionCollect", INDEX_HTML)
        self.assertIn("salonEvidenceGap", INDEX_HTML)
        ...
        self.assertIn("brandPortfolio", INDEX_HTML)
        self.assertIn("renderBrandPortfolio", INDEX_HTML)
        self.assertIn("brandPortfolioStats", INDEX_HTML)
        self.assertIn("brandPortfolioLanes", INDEX_HTML)
        self.assertIn("portfolio-grid", INDEX_HTML)
        self.assertIn("portfolio-card", INDEX_HTML)
        self.assertIn("exportPortfolioCsvBtn", INDEX_HTML)
        self.assertIn("exportPortfolioCsv", INDEX_HTML)
        self.assertIn("csvFromPortfolioRows", INDEX_HTML)
        self.assertIn("lolita-brand-portfolio.csv", INDEX_HTML)
        self.assertIn("noPortfolioCsv", INDEX_HTML)
        self.assertIn("data-portfolio-jump", INDEX_HTML)
        self.assertIn("data-portfolio-sample", INDEX_HTML)
        self.assertIn("portfolioCoreGaps", INDEX_HTML)
        self.assertIn("brandWeightRubric", INDEX_HTML)
        self.assertIn("renderBrandWeightRubric", INDEX_HTML)
        self.assertIn("brandWeightRubricRows", INDEX_HTML)
        self.assertIn("rubric-grid", INDEX_HTML)
        self.assertIn("rubric-card", INDEX_HTML)
        self.assertIn("data-rubric-sample", INDEX_HTML)
        self.assertIn("data-rubric-jump", INDEX_HTML)
        self.assertIn("rubricCore", INDEX_HTML)
        self.assertIn("rubricArchive", INDEX_HTML)
        self.assertIn("brandPlaybook", INDEX_HTML)
        self.assertIn("renderBrandPlaybook", INDEX_HTML)
        self.assertIn("brandPlaybookRows", INDEX_HTML)
        self.assertIn("playbook-card", INDEX_HTML)
        self.assertIn("playbookActionAnchor", INDEX_HTML)
        self.assertIn("playbookReasons", INDEX_HTML)
        self.assertIn("data-playbook-sample", INDEX_HTML)
        self.assertIn("data-playbook-keyword-brand", INDEX_HTML)
        self.assertIn("data-playbook-apply", INDEX_HTML)
        ...
        self.assertIn("styles.length ? `${styles.join", INDEX_HTML)
        ...
        self.assertIn("weightCommandDeck", INDEX_HTML)
        self.assertIn("weight-radar-map", INDEX_HTML)
        self.assertIn("weightRadarNodes", INDEX_HTML)
        self.assertIn("weightRadarPoint", INDEX_HTML)
        ...
        self.assertIn("formula-summary", INDEX_HTML)
        self.assertIn("formulaSummaryHtml", INDEX_HTML)
        self.assertIn("formulaContributionStats", INDEX_HTML)
        self.assertIn("formulaSummaryHint", INDEX_HTML)
        ...
        self.assertIn("prepareCoreWatchSample", INDEX_HTML)
        self.assertIn("setCoreWatchSampleContext", INDEX_HTML)
        self.assertIn("setSampleTaskHint", INDEX_HTML)
        self.assertIn("clearSampleTaskHint", INDEX_HTML)
        self.assertIn("coreMarketWatch", INDEX_HTML)
        self.assertIn("renderCoreMarketWatch", INDEX_HTML)
        self.assertIn("coreMarketWatchRows", INDEX_HTML)
        self.assertIn("coreMarketWatchCardHtml", INDEX_HTML)
        self.assertIn("coreWatchReasons", INDEX_HTML)
        self.assertIn("coreWatchReasonThin", INDEX_HTML)
        self.assertIn("coreWatchPriceAnchorHtml", INDEX_HTML)
        self.assertIn("coreWatchPriceMissing", INDEX_HTML)
        self.assertIn("coreWatchAnchorGaps", INDEX_HTML)
        self.assertIn("coreWatchPriceStatusMissing", INDEX_HTML)
        self.assertIn("hasCoreWatchPriceAnchor", INDEX_HTML)
        self.assertIn("coreWatchNextAction", INDEX_HTML)
        self.assertIn("coreWatchActionAnchor", INDEX_HTML)
        self.assertIn("core-watch-price", INDEX_HTML)
        self.assertIn("core-watch-side", INDEX_HTML)
        self.assertIn("core-watch-card", INDEX_HTML)
        self.assertIn("core-watch-reasons", INDEX_HTML)
        self.assertIn("data-core-watch-brand", INDEX_HTML)
        self.assertIn("data-core-watch-action", INDEX_HTML)
        self.assertIn("exportCoreWatchCsvBtn", INDEX_HTML)
        self.assertIn("exportCoreWatchCsv", INDEX_HTML)
        self.assertIn("csvFromCoreWatchRows", INDEX_HTML)
        self.assertIn("next_action", INDEX_HTML)
        self.assertIn("price_anchor_status", INDEX_HTML)
        self.assertIn("avg_retail_price", INDEX_HTML)
        self.assertIn("avg_resale_price", INDEX_HTML)
        self.assertIn("lolita-core-watch.csv", INDEX_HTML)
        self.assertIn("searchLinkByLabel", INDEX_HTML)
        ...
        self.assertIn("exportMarketActionsCsvBtn", INDEX_HTML)
        self.assertIn("exportMarketActionsCsv", INDEX_HTML)
        self.assertIn("csvFromMarketActionRows", INDEX_HTML)
        self.assertIn("lolita-market-actions.csv", INDEX_HTML)
        self.assertIn("noMarketActionsCsv", INDEX_HTML)
        self.assertIn("resaleRunSheet", INDEX_HTML)
        self.assertIn("renderResaleRunSheet", INDEX_HTML)
        self.assertIn("resaleRunSheetRows", INDEX_HTML)
        self.assertIn("run-sheet-card", INDEX_HTML)
        self.assertIn("data-run-sheet-sample", INDEX_HTML)
        self.assertIn("exportRunSheetCsvBtn", INDEX_HTML)
        self.assertIn("exportRunSheetCsv", INDEX_HTML)
        self.assertIn("csvFromRunSheetRows", INDEX_HTML)
        self.assertIn("lolita-run-sheet.csv", INDEX_HTML)
        self.assertIn("noRunSheetCsv", INDEX_HTML)
        self.assertIn("runSheetRelease", INDEX_HTML)
        self.assertIn('kind: "release"', INDEX_HTML)
        self.assertIn("priceDiscipline", INDEX_HTML)
        self.assertIn("renderPriceDiscipline", INDEX_HTML)
        self.assertIn("priceDisciplineRows", INDEX_HTML)
        self.assertIn("priceDisciplineCeilingRate", INDEX_HTML)
        self.assertIn("priceDisciplineStatus", INDEX_HTML)
        self.assertIn("data-price-discipline-sample", INDEX_HTML)
        self.assertIn("priceDisciplineMissing", INDEX_HTML)
        self.assertIn("priceDisciplineNoRows", INDEX_HTML)
